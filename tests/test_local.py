...
Simula una conversación en la terminal como si fueras una clienta de Milan.
"""
...
async def main():
    ...
    print()
    print("=" * 55)
    print("   AgentKit — Test Local | Milan Renta de Vestidos")
    print("=" * 55)
    print()
    print("  Escribe mensajes como si fueras una clienta.")
    ...
    while True:
        ...
        # Generar respuesta
        print("\nAsistente Milan: ", end="", flush=True)
